      ...
      >
        <div data-cursor-type='wrap' className='products_container'>
          ...
          <h5
            ...
            className='subtitle'
          >
            LOS PRODUCTOS MEJOR VALORADOS <br /> POR NUESTROS <span>BIURY</span>
            MEMBERS
          </h5>
          <div className='productsContain'>
            {products.map((data, index) => {
              return <ProductItem key={index} data={data}></ProductItem>;
            })}
          </div>
        </div>
        <button>
          UNETE A <span>BIURY</span>CLUB
        </button>
